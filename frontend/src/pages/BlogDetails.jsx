    ...
    <article>
      <div className="bg-white">
        <div className="mx-auto max-w-4xl px-4 py-12">
          <Link to="/blogs" className="text-sm font-black text-teal-800">Back to blogs</Link>
          <div className="mt-5 space-y-5">
            ...
            <h1 className="text-4xl font-black leading-tight text-slate-950 md:text-5xl">{post.title}</h1>
            <p className="text-lg leading-8 text-slate-600">{post.shortDescription}</p>
      ...
      <img src={post.coverImageUrl} alt={post.title} className="h-[22rem] w-full object-cover md:h-[30rem]" />

      <div className="mx-auto max-w-3xl px-4 py-12">
        <div className="article-content text-lg leading-8 text-slate-700">
          {post.content.split('\n').map((paragraph, index) => (
